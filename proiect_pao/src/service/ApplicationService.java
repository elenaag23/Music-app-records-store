...
public class ApplicationService {
        ...
        {System.out.println("You cannot delete a song as there are no available songs. Visit the app and add a song.");
            ...
            for(Song song:songCateg)
            {
                ...
                if(song == songs.get(chooseIndex - 1))
                {
                    ...
                    songCategories.put(categ, songCateg);break;
                }
    ...
    public void deletePlaylist()
    {
        ...
        if(podcasts.isEmpty()) {
            System.out.println("You cannot delete a podcast as there are none available. Visit the app and add a playlist.");
            System.out.println("----------------------------------");
        }
        else {
            System.out.println("Here is a list of all the playlists:");
