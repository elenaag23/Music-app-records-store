...
public class Episode extends TypeOfMusic{
    ...
    public Episode(int id, String category, int epNumber, String name, String about, double duration, String date) {
        super(id, category);
        this.epNumber = epNumber;
        this.name = name;
        this.about = about;
    ...
    public Episode(int epNumber, String name, String about, double duration, String date) {
        this.epNumber = epNumber;
        this.name = name;
        this.about = about;
        this.duration = duration;
